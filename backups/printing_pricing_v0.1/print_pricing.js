...
const priceCatalog = {
    2: {
        12: { indoor: 75, outdoor: 90 },
        9: { indoor: 60, outdoor: 75 },
        6: { indoor: 45, outdoor: 60 },
        3: { indoor: 30, outdoor: 45 }
    },
    3: {
        12: { indoor: 100, outdoor: 120 },
        9: { indoor: 80, outdoor: 100 },
        6: { indoor: 60, outdoor: 80 },
        3: { indoor: 40, outdoor: 40 }
    },
    4: {
        12: { indoor: 140, outdoor: 165 },
        9: { indoor: 115, outdoor: 140 },
        6: { indoor: 90, outdoor: 115 },
        3: { indoor: 65, outdoor: 90 }
    },
    5: {
        12: { indoor: 185, outdoor: 215 },
        9: { indoor: 155, outdoor: 185 },
        6: { indoor: 125, outdoor: 155 },
        3: { indoor: 95, outdoor: 125 }
    },
    6: {
        12: { indoor: 235, outdoor: 270 },
        9: { indoor: 200, outdoor: 235 },
        6: { indoor: 165, outdoor: 200 },
        3: { indoor: 130, outdoor: 165 }
    },
    7: {
        12: { indoor: 290, outdoor: 330 },
        9: { indoor: 250, outdoor: 290 },
        6: { indoor: 210, outdoor: 250 },
        3: { indoor: 170, outdoor: 210 }
    },
    8: {
        12: { indoor: 350, outdoor: 395 },
        9: { indoor: 305, outdoor: 350 },
        6: { indoor: 260, outdoor: 305 },
        3: { indoor: 215, outdoor: 260 }
    },
    9: {
        12: { indoor: 415, outdoor: 465 },
        9: { indoor: 365, outdoor: 415 },
        6: { indoor: 315, outdoor: 365 },
        3: { indoor: 265, outdoor: 315 }
    },
    10: {
        12: { indoor: 485, outdoor: 540 },
        9: { indoor: 430, outdoor: 485 },
        6: { indoor: 375, outdoor: 430 },
        3: { indoor: 320, outdoor: 375 }
    },
    11: {
        12: { indoor: 560, outdoor: 620 },
        9: { indoor: 500, outdoor: 560 },
        6: { indoor: 440, outdoor: 500 },
        3: { indoor: 380, outdoor: 440 }
    },
    12: {
        12: { indoor: 640, outdoor: 705 },
        9: { indoor: 575, outdoor: 640 },
        6: { indoor: 510, outdoor: 575 },
        3: { indoor: 445, outdoor: 510 }
    }
};
...
const maxFileSizeMB = 5; // Maximum file size
...
function handleFiles(files) {
    ...
    if (file.size > maxFileSizeMB * 1024 * 1024) {
        alert(`File too large! Maximum ${maxFileSizeMB} MB allowed.`);
        return;
    }
    ...
    reader.onload = (e) => {
        ...
        dropZone.querySelector(".drop-text").style.display = "none"; // hide the text
    };
